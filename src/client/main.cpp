...
unordered_map<string, string> commandMap = {
    ...
    {"creategroup", "创建群组，格式creategroup:groupname:goupdesc"},
        ...
        case 2: // register 业务
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        cout << name << " register success, userid is " << responsejs["js"]
...
void creategroup(int clientfd, string str)
{
    ...
    if (-1 == len)
    {
        cerr << "creategroup msg error ->" << buffer << endl;
    }
}
